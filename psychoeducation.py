# -*- coding: utf-8 -*-
"""psychoeducation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1stokpMXfusBkCvc2CROPO5OiJF7zkxsl
"""
...
Chat_Sharing_Preferences = ["Share with therapist only", "Use for targeted advertisment", "Use for research purposes"]
...
DocumentsSharedWithTherapist = ["Medical history", "Treatment plan or goals", "Worksheets or exercises"] 
...
df_Table.to_csv("shuffeled_data.csv", index=False)
...
# Store the DataFrame in a CSV file
df_sorted2.to_csv("sorted2.csv", index=False)
print(df_sorted2)
