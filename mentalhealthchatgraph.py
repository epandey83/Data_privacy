...
def main():
    ...
    # Create empty lists to store data over time
    probabilities = []
    timestamps = []
    ...
    while True:
        ...
        probabilities.append(y_prob[0])  # Append probability to the list
        timestamps.append(datetime.datetime.now())  # Append timestamp to the list
        ...
        # Plot the line chart
        plt.plot(timestamps, probabilities)
        plt.xlabel("Timestamp")
        plt.ylabel("Probability")
        plt.title("Mental Health Decline Probability over Time")
